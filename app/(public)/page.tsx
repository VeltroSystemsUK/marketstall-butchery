  ...
  : [
      {
        ...
        body: "Browse our full range of dry-aged beef, free-range pork, and Herdwick lamb — every animal reared on our own Derbyshire pasture.",
      },
      {
        icon: ShieldCheck,
        title: "Order securely",
        body: "Checkout with Stripe-powered payment. Choose next-morning chilled delivery or collect directly from the farm.",
      },
      {
        icon: PackageCheck,
        title: "Cut, packed, dispatched",
        body: "We cut to order, vacuum-seal for freshness, and dispatch in chilled packaging every Tuesday and Friday morning.",
      },
    ];
    ...
    <>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center text-white">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm font-medium backdrop-blur-sm">
            <Award className="h-3.5 w-3.5 text-harvest-400" />
            {config.brand.location} · 28-Day Dry-Aged · Est.{" "}
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-white/85 sm:text-xl">
            {config.brand.tagline}. Born and raised on Peak District pasture,
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            >
              Shop our cuts <ArrowRight className="h-4 w-4" />
            </Link>
            <Link
      ...
      <section className="relative overflow-hidden bg-forest-800 py-24">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          ...
          >
            Shop our cuts <ArrowRight className="h-5 w-5" />
          </Link>
        </div>
      </section>
    </>
